...
/**********************************************************************
    ...
    description:
        ...
        general utility functions related to timer scheduling
        operation.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new timer descriptor object.
...
{
    return AnscTdoCreate2(hContainerContext, hOwnerContext, hAnscReserved, file, line);
}
