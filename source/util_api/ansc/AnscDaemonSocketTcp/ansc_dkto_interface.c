...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for Daemon Socket Tcp Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Ansc Daemon Socket Tcp
        object.
    ...
    )
{
    ...
    PANSC_DAEMON_SOCKET_TCP_OBJECT  pDaemonSocketTcp = NULL;

    return  AnscDktoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
