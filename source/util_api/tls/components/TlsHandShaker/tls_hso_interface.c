...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for the TLS Hand Shaker.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new TLS HandShaker object.
...
{
    return  TlsHsoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
