...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for the TLS Env Controller.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new TLS Env Controller
        object.
...
{
    return  TlsEcoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
