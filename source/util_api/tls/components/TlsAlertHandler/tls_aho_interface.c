...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for the TLS Alert Handler.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new TLS Alert Handler
        object.
...
{
    return  TlsAhoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
