...
/**********************************************************************
    ...
    module:	tls_hsoclient_interface.c
    ...
    description:
        ...
        general utility functions for the TLS Hso Client.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new TLS HsoClient object.
...
{
    return  TlsHsoClientCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
