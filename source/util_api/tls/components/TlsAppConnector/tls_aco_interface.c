...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for the TLS App Connector.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new TLS App Connector
        object.
...
{
    return  TlsAcoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
