...
/**********************************************************************
    ...
    module:	tls_hsoserver_interface.c
    ...
    description:
        ...
        general utility functions for the TLS Hso Server.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new TLS HsoServer object.
...
{
    return  TlsHsoServerCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
