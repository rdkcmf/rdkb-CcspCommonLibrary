...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for the TLS Conn Controller.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new TLS Conn Controller
        object.
...
{
    return  TlsCcoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
