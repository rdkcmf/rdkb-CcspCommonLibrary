...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for the TLS Cipher Switch.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new TLS CipherSwitch
        object.
...
{
    return  TlsCsoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
