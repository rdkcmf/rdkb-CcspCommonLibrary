...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for Slap Obj Proxy Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Slap Obj Proxy
        object.
    ...
    )
{
    ...
    PSLAP_OBJ_PROXY_OBJECT          pSlapObjProxy = NULL;

    return  SlapOpoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
