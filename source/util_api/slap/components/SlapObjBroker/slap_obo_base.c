...
/**********************************************************************
    ...
    description:
        ...
        This function constructs the Slap Obj Broker Object and
    ...
    )
{
     ...
     */
    pMyObject = (PSLAP_OBJ_BROKER_OBJECT)AnscAllocateMemory(sizeof(SLAP_OBJ_BROKER_OBJECT));
    ...
    pBaseObject->Oid               = SLAP_OBJ_BROKER_OID;
    pBaseObject->Create            = SlapOboCreate;
    pBaseObject->Remove            = SlapOboRemove;
    pBaseObject->EnrollObjects     = SlapOboEnrollObjects;
    pBaseObject->Initialize        = SlapOboInitialize;
