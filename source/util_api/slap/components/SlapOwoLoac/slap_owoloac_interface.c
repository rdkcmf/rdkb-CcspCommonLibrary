...
/**********************************************************************
    ...
    module:	slap_owoloac_interface.c
    ...
    description:
        ...
        general utility functions for Slap Owo Loac Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Slap Owo Loac
        object.
    ...
    )
{
    ...
    PSLAP_OWO_LOAC_OBJECT           pSlapOwoLoac = NULL;

    return  SlapOwoLoacCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
