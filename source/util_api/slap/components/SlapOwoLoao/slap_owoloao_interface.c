...
/**********************************************************************
    ...
    module:	slap_owoloao_interface.c
    ...
    description:
        ...
        general utility functions for Slap Owo Loao Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Slap Owo Loao
        object.
    ...
    )
{
    ...
    PSLAP_OWO_LOAO_OBJECT           pSlapOwoLoao = NULL;

    return  SlapOwoLoaoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
