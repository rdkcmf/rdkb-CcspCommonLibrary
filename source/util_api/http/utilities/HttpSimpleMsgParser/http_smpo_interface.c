...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for the Component Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new component object.
...
{
    return HttpSmpoDecodeUrlEncode(pStr, ulStrLen, pDecodedStr, pulDecodedStrLen);
}
