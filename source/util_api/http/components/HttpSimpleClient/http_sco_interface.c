...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for Http Simple Client Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Http Simple Client
        object.
    ...
    )
{
    ...
    PHTTP_SIMPLE_CLIENT_OBJECT      pHttpSimpleClient = NULL;

    return  HttpScoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
