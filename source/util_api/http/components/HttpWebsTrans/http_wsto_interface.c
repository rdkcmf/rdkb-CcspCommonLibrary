...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for Http Webs Trans Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Http Webs Trans
        object.
    ...
    )
{
    ...
    PHTTP_WEBS_TRANS_OBJECT         pHttpWebsTrans = NULL;

    return  HttpWstoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
