...
/**********************************************************************
    ...
    module:	http_bmorep_interface.c
    ...
    description:
        ...
        general utility functions for Http Bmo Rep Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Http Bmo Rep object.
    ...
    )
{
    ...
    PHTTP_BMO_REP_OBJECT            pHttpBmoRep  = NULL;

    return  HttpBmoRepCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
