...
/**********************************************************************
    ...
    module: dslh_dmagnt_interface.c
    ...
    description:
        ...
        general utility functions for Dslh DataModelAgent Object;
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Dslh DataModelAgent
        object.
...
{
    return  DslhDmagntCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
