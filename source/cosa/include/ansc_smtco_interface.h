...
/**********************************************************************
    ...
    description:
        ...
        functions and macros for the Smart Clock Object.
...
#ifndef  _ANSC_SMTCO_INTERFACE_
#define  _ANSC_SMTCO_INTERFACE_
...
/***********************************************************
     PLATFORM INDEPENDENT SMART CLOCK OBJECT DEFINITION
***********************************************************/
 ...
 */
typedef  ANSC_HANDLE
(*PFN_SMTCO_GET_CONTEXT)
    (
        ANSC_HANDLE                 hThisObject
    );

typedef  ANSC_STATUS
(*PFN_SMTCO_SET_CONTEXT)
    (
        ANSC_HANDLE                 hThisObject,
 ...
 */
#define  ANSC_SMART_CLOCK_CLASS_CONTENT                                                     \
    /* duplication of the base object class content */                                      \
    ANSC_WALL_CLOCK_CLASS_CONTENT                                                           \
    /* start of object class content */                                                     \
    ANSC_HANDLE                     hSrcWallClock;                                          \
    /* end of object class content */                                                       \

typedef  struct
_ANSC_SMART_CLOCK_OBJECT
{
    ANSC_SMART_CLOCK_CLASS_CONTENT
}
ANSC_SMART_CLOCK_OBJECT,  *PANSC_SMART_CLOCK_OBJECT;

#define  ACCESS_ANSC_SMART_CLOCK_OBJECT(p)          \
         ACCESS_CONTAINER(p, ANSC_SMART_CLOCK_OBJECT, Linkage)
