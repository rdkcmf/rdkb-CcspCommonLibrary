...
/**********************************************************************
    ...
    module:	slee_sboip4o_ipc_params.h
...
#ifndef  _SLEE_SBOIP4O_IPC_PARAMS_
#define  _SLEE_SBOIP4O_IPC_PARAMS_
 ...
 */
#define  SLEE_SBOIP4O_CFG_CODE_BASE                 0x00000000
#define  SLEE_SBOIP4O_CFG_CODE_SETUP                SLEE_SBOIP4O_CFG_CODE_BASE  + 0x0001
 ...
 */
#define  SLEE_SBOIP4O_IPCP_CFG_CONTENT                                                      \
    ...
    ULONG                           CfgCode;                                                \
    ULONG                           TrunkCount;                                             \
    ANSC_IPV4_TRUNK                 TrunkArray[ANSC_ZERO_ARRAY_SIZE];                       \
    /* end of object class content */                                                       \

typedef  struct
_SLEE_SBOIP4O_IPCP_CFG
{
    SLEE_SBOIP4O_IPCP_CFG_CONTENT
}
SLEE_SBOIP4O_IPCP_CFG,  *PSLEE_SBOIP4O_IPCP_CFG;

#define  SLEE_SBOIP4O_IPCR_CFG_CONTENT                                                      \
    /* duplication of the base object class content */                                      \
...
typedef  struct
_SLEE_SBOIP4O_IPCR_CFG
{
    SLEE_SBOIP4O_IPCR_CFG_CONTENT
}
SLEE_SBOIP4O_IPCR_CFG,  *PSLEE_SBOIP4O_IPCR_CFG;
