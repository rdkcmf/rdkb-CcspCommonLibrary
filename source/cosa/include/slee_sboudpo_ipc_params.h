...
/**********************************************************************
    ...
    module:	slee_sboudpo_ipc_params.h
    ...
    revision:
        ...
        08/06/01    initial revision.

**********************************************************************/


#ifndef  _SLEE_SBOUDPO_IPC_PARAMS_
#define  _SLEE_SBOUDPO_IPC_PARAMS_
 ...
 */
#define  SLEE_SBOUDPO_CFG_CODE_BASE                 0x00000000
#define  SLEE_SBOUDPO_CFG_CODE_SETUP                SLEE_SBOUDPO_CFG_CODE_BASE  + 0x0001
 ...
 */
#define  SLEE_SBOUDPO_IPCP_CFG_CONTENT                                                      \
    ...
    ULONG                           CfgCode;                                                \
    ULONG                           TrunkCount;                                             \
    ANSC_UDP_TRUNK                  TrunkArray[ANSC_ZERO_ARRAY_SIZE];                       \
    /* end of object class content */                                                       \

typedef  struct
_SLEE_SBOUDPO_IPCP_CFG
{
    SLEE_SBOUDPO_IPCP_CFG_CONTENT
}
SLEE_SBOUDPO_IPCP_CFG,  *PSLEE_SBOUDPO_IPCP_CFG;

#define  SLEE_SBOUDPO_IPCR_CFG_CONTENT                                                      \
    /* duplication of the base object class content */                                      \
...
typedef  struct
_SLEE_SBOUDPO_IPCR_CFG
{
    SLEE_SBOUDPO_IPCR_CFG_CONTENT
}
SLEE_SBOUDPO_IPCR_CFG,  *PSLEE_SBOUDPO_IPCR_CFG;
