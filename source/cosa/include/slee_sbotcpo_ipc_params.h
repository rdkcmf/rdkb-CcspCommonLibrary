...
/**********************************************************************
    ...
    module:	slee_sbotcpo_ipc_params.h
    ...
    revision:
        ...
        08/05/01    initial revision.

**********************************************************************/


#ifndef  _SLEE_SBOTCPO_IPC_PARAMS_
#define  _SLEE_SBOTCPO_IPC_PARAMS_
 ...
 */
#define  SLEE_SBOTCPO_CFG_CODE_BASE                 0x00000000
#define  SLEE_SBOTCPO_CFG_CODE_SETUP                SLEE_SBOTCPO_CFG_CODE_BASE  + 0x0001
 ...
 */
#define  SLEE_SBOTCPO_IPCP_CFG_CONTENT                                                      \
    ...
    ULONG                           CfgCode;                                                \
    ULONG                           TrunkCount;                                             \
    ANSC_TCP_TRUNK                  TrunkArray[ANSC_ZERO_ARRAY_SIZE];                       \
    /* end of object class content */                                                       \

typedef  struct
_SLEE_SBOTCPO_IPCP_CFG
{
    SLEE_SBOTCPO_IPCP_CFG_CONTENT
}
SLEE_SBOTCPO_IPCP_CFG,  *PSLEE_SBOTCPO_IPCP_CFG;

#define  SLEE_SBOTCPO_IPCR_CFG_CONTENT                                                      \
    /* duplication of the base object class content */                                      \
...
typedef  struct
_SLEE_SBOTCPO_IPCR_CFG
{
    SLEE_SBOTCPO_IPCR_CFG_CONTENT
}
SLEE_SBOTCPO_IPCR_CFG,  *PSLEE_SBOTCPO_IPCR_CFG;
