...
/**********************************************************************
    ...
    module:	slee_sboetho_ipc_params.h
...
#ifndef  _SLEE_SBOETHO_IPC_PARAMS_
#define  _SLEE_SBOETHO_IPC_PARAMS_
 ...
 */
#define  SLEE_SBOETHO_CFG_CODE_BASE                 0x00000000
#define  SLEE_SBOETHO_CFG_CODE_SETUP                SLEE_SBOETHO_CFG_CODE_BASE  + 0x0001
 ...
 */
#define  SLEE_SBOETHO_IPCP_CFG_CONTENT                                                      \
    ...
    ULONG                           CfgCode;                                                \
    ULONG                           TrunkCount;                                             \
    ANSC_ETHERNET_TRUNK             TrunkArray[ANSC_ZERO_ARRAY_SIZE];                       \
    /* end of object class content */                                                       \

typedef  struct
_SLEE_SBOETHO_IPCP_CFG
{
    SLEE_SBOETHO_IPCP_CFG_CONTENT
}
SLEE_SBOETHO_IPCP_CFG,  *PSLEE_SBOETHO_IPCP_CFG;

#define  SLEE_SBOETHO_IPCR_CFG_CONTENT                                                      \
    /* duplication of the base object class content */                                      \
...
typedef  struct
_SLEE_SBOETHO_IPCR_CFG
{
    SLEE_SBOETHO_IPCR_CFG_CONTENT
}
SLEE_SBOETHO_IPCR_CFG,  *PSLEE_SBOETHO_IPCR_CFG;
