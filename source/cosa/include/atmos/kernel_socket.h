 ...
 */
    ...
    typedef  struct     dns_hostent     ansc_hostent,           *pansc_hostent;
    ...
    #define  _ansc_get_last_error                   __get_errno
    ...
    #define  ANSC_SOCKET_FD_ISNUL(set)              ( (((fd_set*)(set))->fd_count == 0) )
    #define  ANSC_SOCKET_FD_GET(set, s, i)                                                      \
             {                                                                                  \
                fd_set*                 socket_set = (fd_set*)set;                              \
 ...
 */
    ...
    typedef  struct     dns_hostent     xskt_hostent,           *pxskt_hostent;
    ...
    #define  _xskt_get_last_error                   __get_errno
