...
/**********************************************************************
    ...
    description:
        ...
        describe Daemon Server Tcp Object.
...
#ifndef  _ANSC_DSTO_PROPERTIES_
#define  _ANSC_DSTO_PROPERTIES_


/***********************************************************
      DAEMON SERVER TCP OBJECT PROPERTY DATA STRUCTURES
***********************************************************/

/*
 * Overview form reveals the general information about the Daemon Server Object:
 *
...
ANSC_DSTO_OVERVIEW_FORM,  *PANSC_DSTO_OVERVIEW_FORM;
...
ANSC_DSTO_SNAPSHOT_FORM,  *PANSC_DSTO_SNAPSHOT_FORM;
 ...
 */
#define  ANSC_MAX_DSTO_SOCKET_COUNT                 128

typedef  struct
_ANSC_DSTO_SOCKET_INFO
{
    ULONG                           StartTime;                                  /* system-up time in seconds     */
    ULONG                           CurrentTime;                                /* system-up time in seconds     */
...
ANSC_DSTO_SOCKET_INFO,  *PANSC_DSTO_SOCKET_INFO;

typedef  struct
_ANSC_DSTO_CLOSE_UP_FORM
{
    ULONG                           EngineIndex;                                /* index of the active engine */
    ULONG                           SocketCount;                                /* size of the socket array   */
    ANSC_DSTO_SOCKET_INFO           SocketArray[ANSC_MAX_DSTO_SOCKET_COUNT];    /* socket info array          */
}
ANSC_DSTO_CLOSE_UP_FORM,  *PANSC_DSTO_CLOSE_UP_FORM;
