...
/**********************************************************************
    ...
    module:	slee_sboipcompo_ipc_params.h
...
#ifndef  _SLEE_SBOIPCOMPO_IPC_PARAMS_
#define  _SLEE_SBOIPCOMPO_IPC_PARAMS_
 ...
 */
#define  SLEE_SBOIPCOMPO_CFG_CODE_BASE              0x00000000
#define  SLEE_SBOIPCOMPO_CFG_CODE_SETUP             SLEE_SBOIPCOMPO_CFG_CODE_BASE  + 0x0001
 ...
 */
#define  SLEE_SBOIPCOMPO_IPCP_CFG_CONTENT                                                   \
    ...
    ULONG                           CfgCode;                                                \
    ULONG                           TrunkCount;                                             \
    ANSC_IPCOMP_TRUNK               TrunkArray[ANSC_ZERO_ARRAY_SIZE];                       \
    /* end of object class content */                                                       \

typedef  struct
_SLEE_SBOIPCOMPO_IPCP_CFG
{
    SLEE_SBOIPCOMPO_IPCP_CFG_CONTENT
}
SLEE_SBOIPCOMPO_IPCP_CFG,  *PSLEE_SBOIPCOMPO_IPCP_CFG;

#define  SLEE_SBOIPCOMPO_IPCR_CFG_CONTENT                                                   \
    /* duplication of the base object class content */                                      \
...
typedef  struct
_SLEE_SBOIPCOMPO_IPCR_CFG
{
    SLEE_SBOIPCOMPO_IPCR_CFG_CONTENT
}
SLEE_SBOIPCOMPO_IPCR_CFG,  *PSLEE_SBOIPCOMPO_IPCR_CFG;
