...
/**********************************************************************
    ...
    module:	slee_sboespo_ipc_params.h
...
#ifndef  _SLEE_SBOESPO_IPC_PARAMS_
#define  _SLEE_SBOESPO_IPC_PARAMS_
 ...
 */
#define  SLEE_SBOESPO_CFG_CODE_BASE                 0x00000000
#define  SLEE_SBOESPO_CFG_CODE_SETUP                SLEE_SBOESPO_CFG_CODE_BASE  + 0x0001
 ...
 */
#define  SLEE_SBOESPO_IPCP_CFG_CONTENT                                                      \
    ...
    ULONG                           CfgCode;                                                \
    ULONG                           TrunkCount;                                             \
    ANSC_ESP_TRUNK                  TrunkArray[ANSC_ZERO_ARRAY_SIZE];                       \
    /* end of object class content */                                                       \

typedef  struct
_SLEE_SBOESPO_IPCP_CFG
{
    SLEE_SBOESPO_IPCP_CFG_CONTENT
}
SLEE_SBOESPO_IPCP_CFG,  *PSLEE_SBOESPO_IPCP_CFG;

#define  SLEE_SBOESPO_IPCR_CFG_CONTENT                                                      \
    /* duplication of the base object class content */                                      \
...
typedef  struct
_SLEE_SBOESPO_IPCR_CFG
{
    SLEE_SBOESPO_IPCR_CFG_CONTENT
}
SLEE_SBOESPO_IPCR_CFG,  *PSLEE_SBOESPO_IPCR_CFG;
