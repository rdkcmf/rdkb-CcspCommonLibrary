...
/**********************************************************************
    ...
    module:	ansc_uint_co_interface.h
...
#ifndef  _ANSC_UINT_ARRAY_INTERFACE_DEC
#define  _ANSC_UINT_ARRAY_INTERFACE_DEC
...
#define  ANSC_UINT_ARRAY_COMPONENT_NAME             "UIntArrayComponent"
#define  ANSC_UINT_ARRAY_COMPONENT_OID              ANSC_OBJECT_OID_NULL
#define  ANSC_UINT_ARRAY_COMPONENT_TYPE             ANSC_OBJECT_TYPE_NULL


typedef
void
(*PFN_UINT_ARRAY_ENLARGE)
    (   
 ...
 * larger systems.
 */
#define  ANSC_UINT_ARRAY_CLASS_CONTENT                                                  \
    ...
    ULONG                           ulItemCount;                                        \
    /* start of methods */                                                              \
    PFN_UINT_ARRAY_ENLARGE          EnlargeStorage;                                     \

/* content filtering basic message object  */
typedef  struct
_ANSC_UINT_ARRAY_OBJECT
{
    ANSC_UINT_ARRAY_CLASS_CONTENT
}
ANSC_UINT_ARRAY_OBJECT,    *PANSC_UINT_ARRAY_OBJECT;


#define  ACCESS_ANSC_UINT_ARRAY_OBJECT(p)            \
         ACCESS_CONTAINER(p, ANSC_UINT_ARRAY_OBJECT, Linkage)
