    ...
    )
{
    ...
    PBSP_TEMPLATE_TEMP_OBJECT       pMyObject    = NULL;

    /*
     * We create object by first allocating memory for holding the variables and member functions.
     */
    pMyObject = (PBSP_TEMPLATE_TEMP_OBJECT)AnscAllocateMemory(sizeof(BSP_TEMPLATE_TEMP_OBJECT));
    ...
    pMyObject->Initialize                   = BspTemplateTempCOInitialize;
    pMyObject->Remove                       = BspTemplateTempCORemove;
    ...
    )
{
    ...
    pMyObject->Clear                        = BspTemplateTempClear;
    pMyObject->Release                      = BspTemplateTempRelease;
    pMyObject->Set                          = BspTemplateTempSet;
