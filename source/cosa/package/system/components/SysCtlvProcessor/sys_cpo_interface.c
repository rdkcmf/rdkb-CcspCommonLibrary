...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for Sys Ctlv Processor Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Sys Ctlv Processor
        object.
...
{
    return  SysCpoCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
