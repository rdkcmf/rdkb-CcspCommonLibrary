...
/**********************************************************************
    ...
    module:	sys_rroastr_interface.c
    ...
    description:
        ...
        general utility functions for Sys Rro Astr Object.
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Sys Rro Astr object.
    ...
    )
{
    ...
    PSYS_RRO_ASTR_OBJECT            pSysRroAstr  = NULL;

    return  SysRroAstrCreate(hContainerContext, hOwnerContext, hAnscReserved);
}
