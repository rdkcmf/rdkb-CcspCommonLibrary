...
/**********************************************************************
    ...
    description:
        ...
        general utility functions for Sys Info Repository Object.

        *   SysCreateInfoRepositoryV2
...
/**********************************************************************
    ...
    description:
        ...
        This function is called to create a new Sys Info Repository
        object.
    ...
    )
{
    ...
    return  SysIroV2Create(hContainerContext, hOwnerContext, hAnscReserved);
}
